...
public class MongoTest {
	...
	private static void genTestDataIntoApp(){
		...
		for(int i=0;i<10000;i++){
			...
			field.append("name", "performent_"+i)
			     .append("displayName", "performent_"+i)
			     .append("image", "")
			     .append("memory", 256)
			     .append("instance", 0)
			     .append("status", "0")
			     .append("description", "test")
			     .append("picId", "d11a2cb68d2842d795574b946660546d")
			     .append("catId", "2")
			     .append("appType", "URL")
			     .append("url", "")
			     .append("healthAddress", "")
			     .append("healthContactEMail", "")
			     .append("createrName", "")
			     .append("dCreate", new Date())
			     .append("updaterName", null)
			     .append("dUpdate", null)
			     .append("applyType", "regist")
			     .append("suggestion", "processing")
			     .append("remark", "")
