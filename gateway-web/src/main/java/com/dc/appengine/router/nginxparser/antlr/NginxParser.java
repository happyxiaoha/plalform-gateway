...
import com.dc.appengine.router.nginxparser.*;
			...
			do {
				...
				case 1:
					...
					((ConfigContext)_localctx).statement = statement();
					 _localctx.ret.addEntryAtLast(((ConfigContext)_localctx).statement.ret); 
					}
					break;
				case 2:
					{
					...
					((ConfigContext)_localctx).block = block();
					 _localctx.ret.addEntryAtLast(((ConfigContext)_localctx).block.ret); 
					}
					break;
				case 3:
					{
					...
					((ConfigContext)_localctx).Comment = match(Comment);
					 _localctx.ret.addEntryAtLast(new NgxComment((((ConfigContext)_localctx).Comment!=null?((ConfigContext)_localctx).Comment.getText():null))); 
					}
					break;
				}
				}
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__3) | (1L << T__8) | (1L << T__9) | (1L << Value) | (1L << Comment) | (1L << REGEXP_PREFIXED))) != 0)) {
				...
				case 1:
					...
					((BlockContext)_localctx).statement = statement();
					 _localctx.ret.addEntryAtLast(((BlockContext)_localctx).statement.ret); 
					}
					break;
				case 2:
					{
					...
					((BlockContext)_localctx).b = block();
					 _localctx.ret.addEntryAtLast(((BlockContext)_localctx).b.ret); 
					}
					break;
				case 3:
					{
					...
					((BlockContext)_localctx).if_statement = if_statement();
					 _localctx.ret.addEntryAtLast(((BlockContext)_localctx).if_statement.ret); 
					}
					break;
				case 4:
					{
					setState(85);
					((BlockContext)_localctx).Comment = match(Comment);
					 _localctx.ret.addEntryAtLast(new NgxComment((((BlockContext)_localctx).Comment!=null?((BlockContext)_localctx).Comment.getText():null))); 
					}
					break;
				}
				}
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__9) | (1L << Value) | (1L << REGEXP_PREFIXED))) != 0)) {
				...
				((If_statementContext)_localctx).statement = statement();
				 _localctx.ret.addEntryAtLast(((If_statementContext)_localctx).statement.ret); 
				}
				}
				setState(121);
				_errHandler.sync(this);
